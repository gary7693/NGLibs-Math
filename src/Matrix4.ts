...
let _v1_:Vector3|null = null;
function _v1():Vector3 {
	_v1_ = _v1_ ? _v1_ : new  Vector3();
	return _v1_;
}
let  _m1_:Matrix4|null = null;
function _m1():Matrix4 {
	_m1_ = _m1_ ? _m1_ : new  Matrix4();
	return _m1_;
}
let  _zero_:Vector3 |null = null;
function  _zero():Vector3 {
	_zero_ =  _zero_ ?  _zero_ : new  Vector3(0,0,0);
	return  _zero_;
}
let  _one_:Vector3  |null = null;
function  _one():Vector3 {
	_one_ =  _one_ ?  _one_ : new  Vector3(1,1,1);
	return  _one_;
}
let  _x_:Vector3|null = null;
function  _x():Vector3 {
	_x_ =   _x_ ?   _x_ : new  Vector3();
	return  _x_;
}
let  _y_:Vector3|null = null;
function  _y():Vector3 {
	_y_ =  _y_ ?  _y_ : new  Vector3();
	return  _y_;
}

let  _z_:Vector3 | null = null;
function _z():Vector3 {
	_z_ =  _z_ ?  _z_ : new  Vector3();
	return  _z_;
}
